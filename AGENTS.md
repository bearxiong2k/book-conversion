...
- Generated book HTML should be self-contained when it includes figures or inline images: embed image payloads as `data:image` URIs after deterministic extraction/cleanup. Keep source assets only as regeneration inputs, not runtime dependencies.
